...
public class StoneLocal {
	...
	public StoneLocal(Location loc) {
	...
	public StoneLocal(JSONObject jsonO) {
	...
	public StoneLocal(ResultSet rs) throws SQLException {
