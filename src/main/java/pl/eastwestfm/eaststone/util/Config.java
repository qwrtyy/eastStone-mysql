...
//  base: 12321123
	...
	public void loadConfig() {
        ...
        this.databaseHost = f.getString("database.host");
        this.databasePort = f.getInt("database.port");
        this.databasePass = f.getString("database.pass");
        this.databaseUser = f.getString("database.user");
        this.databaseBase = f.getString("database.base");
